...
<Workflow version="1.0">
	<Definition name="actionAddPermissions" description="Add permissions for a given application and a given individual" scriptfile="/workflow/bw_action_pack/actionpack/actionAddPermissions.javascript" statictitle="Add permissions for a given application and a given individual" displayname="Permissions manual add">
		<Component name="CSTART" type="startactivity" x="45" y="95" w="200" h="114" title="Start" compact="true">
			<Actions>
				...
				<Action name="U1422608523626" action="update" attribute="permissionstring" newvalue="{dataset.permissions.toString()}"/>
			</Actions>
			<Ticket create="true">
				<Attribute name="tickettype" attribute="TICKETTYPE"/>
				<Attribute name="custom1" attribute="applicationname"/>
				<Attribute name="custom2" attribute="permissionstring"/>
		...
		<Component name="C1415631278443" type="manualactivity" x="184" y="62" w="200" h="114" title="Add {dataset.applicationname.get()} permissions for {dataset.identityfullname.get()}" duedate="{dataset.duedate.get()}">
			...
			<Page name="actionAddPermissions" template="/library/pagetemplates/workflow/manualActivity.pagetemplate"/>
	...
	<Variables>
		...
		<Variable name="A1415736888767" variable="prioritylevel" displayname="priority level" editortype="Default" type="String" multivalued="false" visibility="in" description="priority level" initialvalue="2" notstoredvariable="false"/>
		<Variable name="A1415736903137" variable="progressCurrent" displayname="progress Current" editortype="Default" type="Number" multivalued="false" visibility="local" description="Current Progress" notstoredvariable="false"/>
		<Variable name="A1415736918325" variable="progressTotal" displayname="progress Total" editortype="Default" type="Number" multivalued="false" visibility="local" description="Total Progress" notstoredvariable="false"/>
		<Variable name="A1415736928281" variable="parentprocessid" displayname="parent process id" editortype="Default" type="String" multivalued="false" visibility="in" description="parent process id" notstoredvariable="false"/>
		<Variable name="A1415737904288" variable="duedate" displayname="duedate" editortype="Default" type="Date" multivalued="false" visibility="in" description="duedate" notstoredvariable="false"/>
		<Variable name="A1422608393833" variable="TICKETTYPE" editortype="Default" type="String" multivalued="false" visibility="local" initialvalue="AP-ADDPERM" notstoredvariable="false"/>
		<Variable name="A1422608499780" variable="permissionstring" editortype="Default" type="String" multivalued="false" visibility="local" notstoredvariable="false"/>
	</Variables>
	<Roles>
	...
	<Mails>
		<Mail name="A1415631510699" displayname="Add permissions" description="Add permissions" toaddtaskrole="true" notifyrule="actionpackAddPermissions">
