...
<Workflow version="1.0">
	<Definition name="actionRemoveAccount" displayname="Account manual removal" description="This workflow is a technical workflow, it is used as a place holder to embed all the technical activities related to removing an account.&#xA;This workflow cannot be used directly, it is called by other process as a technical activity.&#xA;" scriptfile="/workflow/bw_action_pack/actionpack/actionRemoveAccount.javascript" statictitle="A simple action workflow to remove an account">
		...
		<Component name="C1415608684127" type="manualactivity" x="287" y="52" w="200" h="114" title="Remove account {dataset.accountLogin.get()} on {dataset.accountRepository.get()}" inexclusive="true" duedate="{dataset.duedate.get()}">
			...
			<FormVariable name="A1415610150653" layoutelement="inserttitle" elementtitle="Please remove the following account" jointeditionadd="false" jointeditionmodify="false" jointeditiondelete="false" action="input"/>
			...
			<Page name="actionRemoveAccount" template="/library/pagetemplates/workflow/manualActivity.pagetemplate"/>
		...
		<Link name="L1415609259294" source="CSTART" target="C1415608684127" priority="1" labelcustom="false" label="Account is active"/>
	</Definition>
	<Variables>
		...
		<Variable name="A1415737106252" variable="prioritylevel" displayname="priority level" editortype="Default" type="String" multivalued="false" visibility="in" description="priority level" initialvalue="2" notstoredvariable="false"/>
		<Variable name="A1415737118141" variable="progressCurrent" displayname="progress Current" editortype="Default" type="Number" multivalued="false" visibility="local" description="Current Progress" notstoredvariable="false"/>
		<Variable name="A1415737132415" variable="progressTotal" displayname="progress Total" editortype="Default" type="Number" multivalued="false" visibility="local" description="Total Progress" initialvalue="100" notstoredvariable="false"/>
		<Variable name="A1415737147869" variable="parentprocessid" displayname="parent process id" editortype="Default" type="String" multivalued="false" visibility="in" description="parent process id" notstoredvariable="false"/>
		<Variable name="A1415737933252" variable="duedate" displayname="duedate" editortype="Default" type="Date" multivalued="false" visibility="in" description="duedate" notstoredvariable="false"/>
		<Variable name="A1422606703800" variable="TICKETTYPE" editortype="Default" type="String" multivalued="false" visibility="local" initialvalue="AP-REMOVEACCOUNT" notstoredvariable="false"/>
	</Variables>
	<Roles>
	...
	<Mails>
		<Mail name="A1415609982393" displayname="Remove account notification" description="Remove account notification" toaddtaskrole="true" notifyrule="actionpackRemoveaccount">
