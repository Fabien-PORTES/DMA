...
<Workflow version="1.0">
	<Definition name="actionRemovePermissions" displayname="Permissions manual removal" description="Remove permissions for a given application and a given individual" scriptfile="/workflow/bw_action_pack/actionpack/actionRemovePermissions.javascript" statictitle="Remove permissions for a given application and a given individual">
		<Component name="CSTART" type="startactivity" x="45" y="95" w="200" h="114" title="Start" compact="true">
			<Actions>
				...
				<Action name="U1422606408574" action="update" attribute="permissionstring" newvalue="{dataset.permissioncodes.toString()}"/>
			</Actions>
			<Ticket create="true">
		...
		<Component name="C1415631278443" type="manualactivity" x="184" y="62" w="200" h="114" title="Remove {dataset.applicationname.get()} permissions for {dataset.identityfullname.get()}" duedate="{dataset.duedate.get()}">
			...
			<Page name="actionRemovePermissions" template="/library/pagetemplates/workflow/manualActivity.pagetemplate"/>
	...
	<Variables>
		...
		<Variable name="A1415737229045" variable="prioritylevel" displayname="priority level" editortype="Default" type="String" multivalued="false" visibility="in" description="priority level" initialvalue="2" notstoredvariable="false"/>
		<Variable name="A1415737241866" variable="progressCurrent" displayname="progress Current" editortype="Default" type="Number" multivalued="false" visibility="local" description="progress Current" initialvalue="0" notstoredvariable="false"/>
		<Variable name="A1415737257208" variable="progressTotal" displayname="progress Total" editortype="Default" type="Number" multivalued="false" visibility="local" description="Total Progress" initialvalue="100" notstoredvariable="false"/>
		<Variable name="A1415737273202" variable="parentprocessid" displayname="parent process id" editortype="Default" type="String" multivalued="false" visibility="in" description="parent process id" notstoredvariable="false"/>
		<Variable name="A1415737954645" variable="duedate" displayname="duedate" editortype="Default" type="Date" multivalued="false" visibility="in" description="duedate" notstoredvariable="false"/>
		<Variable name="A1422606375951" variable="permissionstring" editortype="Default" type="String" multivalued="false" visibility="local" notstoredvariable="false"/>
		<Variable name="A1422606453174" variable="TICKETTYPE" editortype="Default" type="String" multivalued="false" visibility="local" initialvalue="AP-REMOVEPERM" notstoredvariable="false"/>
	</Variables>
	<Roles>
	...
	<Mails>
		<Mail name="A1415631510699" displayname="Remove permissions" description="Remove permissions" toaddtaskrole="true" notifyrule="actionpackRemovePermissions">
