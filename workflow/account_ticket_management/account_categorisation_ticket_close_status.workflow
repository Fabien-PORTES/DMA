...
<Workflow version="1.0">
	<Definition name="account_categorisation_ticket_close_status" displayname="Technical workflow to change status to CLOSED" description="Technical workflow to change status to CLOSED" scriptfile="/workflow/account_ticket_management/account_categorisation_ticket_close_status.javascript" technical="true" statictitle="account_categorisation_ticket_close_status">
		...
		<Component name="C1486551374396" type="ticketreviewactivity" x="386" y="9" w="200" h="98" title="Then create CLOSED ticket with same infos">
	...
	<Variables>
		...
		<Variable name="A1486551333690" variable="ticket_review_status" displayname="ticket_review_status" editortype="Default" type="String" multivalued="true" visibility="local" initialvalue="CLOSED" notstoredvariable="false"/>
